////////////////////////////////////////////////////////////////////////////
//
// BMP2C		By J. Flynn 5/23/98
//
// Converts a patch or graphic .BMP file to a predefined lump for
// inclusion of INFO.C of the BOOM sources
//
//
////////////////////////////////////////////////////////////////////////////
...
// structure for DOOM's post picture format
...
// definitions for bitmap (.BMP) file format
...
//
// bytes: pointer to bitmap data for BMP under conversion to DOOM picture
// logw:  logical width of row of pixels in BMP (always multiple of 4)
// rwid:  actual width of picture data in BMP (may not be multiple of 4)
// logh:  number of rows of data in BMP
// p:     pointer to DOOM picture data structure to fill (return value)
// pf:    whether a GRAPHIC(0) or PATCH(1) lump is created (affects offsets)
//
...
void ConvertToPicture(BYTE *bytes,int logw,int rwid,int logh,PicData *p,int pf)
{
	...
	// allocate array of column offsets in picture data
	p->coloffs = (long *)malloc(logw*sizeof(int));
	// support pictures up to 1024X512 in size
	p->posts = (unsigned char *)malloc(1024*512*sizeof(unsigned char));
...
// ReadBMP
//
// Reads BMP file and creates array of bytes representing the bitmap
...
//
// out:       pointer to array of bytes to hold bitmap of BMP read
// logw:      pointer to logical width of BMP (always multiple of 4)
// realw:     pointer to actual width of picture data in BMP
// logh:      pointer to number of rows of picture data in BMP
// bmpname:   filename of BMP to read (including extension .BMP)
//
...
// WritePic
//
// Read a .BMP file and write to a file as a C syntax data structure
// in DOOM picture format.
//
// path:  name of BMP file to read (including .BMP extension)
// st:    stream to write output text file on
// pf:    whether a patch or graphic picture is being read
//
...
// as a collection of C arrays to a text file, CDATA.C
//
